 ...
 * @since 2014
 */
public abstract class OnAppRequestSuccessActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	
	protected OnAppRequestSuccessActionCallback(FragmentActivity activity) {
