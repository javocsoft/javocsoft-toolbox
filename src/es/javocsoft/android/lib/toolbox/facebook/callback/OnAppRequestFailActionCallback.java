 ...
 * @since 2014
 */
public abstract class OnAppRequestFailActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	
	protected OnAppRequestFailActionCallback(FragmentActivity activity) {
