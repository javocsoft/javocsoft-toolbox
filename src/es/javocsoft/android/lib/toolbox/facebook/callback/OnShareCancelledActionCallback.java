...
/**
 * This class allows to do something when FB share is cancelled.
 * 
 ...
 * @since 2014
 */
public abstract class OnShareCancelledActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	
	protected OnShareCancelledActionCallback(FragmentActivity activity) {
