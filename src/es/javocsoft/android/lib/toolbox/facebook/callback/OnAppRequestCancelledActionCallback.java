 ...
 * is cancelled.
 * 
 * Application must be logged with facebook Login in order to send
 * application request.<br><br>
 * 
 ...
 * @since 2014
 */
public abstract class OnAppRequestCancelledActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	
	protected OnAppRequestCancelledActionCallback(FragmentActivity activity) {
