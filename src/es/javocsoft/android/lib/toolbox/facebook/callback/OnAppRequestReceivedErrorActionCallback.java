 ...
 * @since 2014
 */
public abstract class OnAppRequestReceivedErrorActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	protected String errorMessage;
	
	protected OnAppRequestReceivedErrorActionCallback(FragmentActivity activity) {
