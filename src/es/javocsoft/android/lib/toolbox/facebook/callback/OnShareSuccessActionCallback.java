...
/**
 * This class allows to do something when FB share is successfully done.
 * 
 ...
 * @since 2014
 */
public abstract class OnShareSuccessActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	
	protected OnShareSuccessActionCallback(FragmentActivity activity) {
