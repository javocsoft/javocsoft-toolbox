 ...
 * is successfully deleted from Facebook once is processed..
 * 
 * Application must be logged with facebook Login.<br><br>
 * 
 ...
 * @since 2014
 */
public abstract class OnAppRequestDeleteSuccessActionCallback extends Thread implements Runnable {
	
	protected FragmentActivity activity;
	protected Context appContext;
	
	protected OnAppRequestDeleteSuccessActionCallback(FragmentActivity activity) {
