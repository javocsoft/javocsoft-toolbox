...
/**
 * Base callback class to use when getting a file from Drive.
 *  
 * @author JavocSoft 2015
 * @version 1.0
 *
 */
public abstract class TBDriveGetFileCallback extends Thread implements Runnable {
	...
	public TBDriveGetFileCallback(Context context) {
